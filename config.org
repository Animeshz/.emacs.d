...
(setq-default fill-column 500  ; SPC-c
...
(org-babel-do-load-languages 'org-babel-load-languages
                             '((emacs-lisp . t) (shell . t) (python . t) (ruby . t) (C . t) (js . t) (sql . t)))  ; C-c C-c
...
(add-to-list 'load-path "/nix/store/0lhzi2473ngzg5bxpa8incpjlyh3vdpk-emacs-emacs-pcre-bc63431cff76dae6ccbff6470173c96ff037fae7/share/emacs/site-lisp")
(require 'pcre)
...
#+BEGIN_SRC emacs-lisp
;; (use-package chdir
;;   :ensure (chdir :host github :repo "Animeshz/emacs-chdir"
