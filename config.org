...
; https://stackoverflow.com/a/10110113/11377112
(setq initial-scratch-message "// This is scratch buffer, won't be saved unless saved as a file with :w <filename>.\n\n")
...
(defun org-export-deterministic-reference (references)
  (let ((new (/ (length references) 3))) (while (rassq new references) (setq new (+ new 1))) new))
