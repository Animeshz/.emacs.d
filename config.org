...
Almost everything is mode, and has a mode-map associated with it. In a buffer, there's a major mode and multiple minor
modes. Read more about them [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Modes.html][here]].
