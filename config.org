...
(use-package telephone-line
  ...
  ;; (custom-set-faces
  ;;  `(telephone-line-evil-insert ((t (:background ,(cadr evil-insert-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-normal ((t (:background ,(cadr evil-normal-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-visual ((t (:background ,(cadr evil-visual-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-replace ((t (:background ,(cadr evil-replace-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-motion ((t (:background ,(cadr evil-motion-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-operator ((t (:background ,(cadr evil-operator-state-cursor) :inherit telephone-line-evil))))
  ;;  `(telephone-line-evil-emacs ((t (:background ,(cadr evil-emacs-state-cursor) :inherit telephone-line-evil)))))
  ...
  (setq telephone-line-rhs
        '((nil    . (telephone-line-dir telephone-line-misc-info-segment))
          ...
          (evil   . (telephone-line-visual-selected-char-count (telephone-line-airline-position-segment :args (0 0))))))
